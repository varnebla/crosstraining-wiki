...
<search class="text-white" >
	<div class="relative">
		<input
			...
			class="w-full p-4 pe-12 border rounded-md focus:border-slate-600 focus:ring-2 focus:ring-slate-600 border-slate-600 bg-slate-700/20 block focus:outline-slate-600"
			autofocus
		/>
